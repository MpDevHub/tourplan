...
const currentAudioSrc1 = ref("");
const currentAudioSrc2 = ref("");
const currentAudioSrc3 = ref("");
// const currentAudio = ref(null)

function playAudio(country) {
  switch (country) {
    case "china":
      ...
      break;
    case "indo":
      currentAudioSrc.value = "https://github.com/MpDevHub/tourplan/raw/main/public/Audio/IDN/J1_Lobby_Depan.mp3";
      break;
    case "usa":
      currentAudioSrc.value = "https://github.com/MpDevHub/tourplan/raw/main/public/J1_Front_Lobby.mp3";
      break;
  }

  audioPlayer.value.load();
  audioPlayer.value.play();
  // audioPlayer.value.playbackRate = 1.25;
}

function playAudioj2(country) {
  switch (country) {
    case "china":
      currentAudioSrc1.value =
        "https://download.samplelib.com/mp3/sample-3s.mp3";
      break;
    case "indo":
      currentAudioSrc1.value = "https://github.com/MpDevHub/tourplan/raw/main/public/Audio/IDN/J2_Depan_PO-Supir.mp3";
      break;
    case "usa":
      currentAudioSrc1.value = "https://github.com/MpDevHub/tourplan/raw/main/public/J2_Front_of_Driver's_Post.mp3";
      break;
  }

  audioPlayer1.value.load();
  audioPlayer1.value.play();
  // audioPlayer1.value.playbackRate = 1.25;
}

function playAudioj3(country) {
  switch (country) {
    case "china":
      currentAudioSrc2.value =
        "https://download.samplelib.com/mp3/sample-3s.mp3";
      break;
    case "indo":
  ...
  // audioPlayer2.value.playbackRate = 1.25;
}

function playAudioj4(country) {
  switch (country) {
    case "china":
      currentAudioSrc3.value =
        "https://download.samplelib.com/mp3/sample-3s.mp3";
      break;
    case "indo":
  ...
  audioPlayer3.value.load();
  audioPlayer3.value.play();
  // audioPlayer3.value.playbackRate = 1.25;
}
</script>
  ...
  >
    ...
    <div className="grid grid-cols-1 gap-4">
      <div class="hero-content text-neutral-content text-center">
        <div class="max-w-md">
          <h1 class="mb-5 text-5xl font-bold">Play Audio</h1>
          <p class="mb-5"></p>
        </div>
      </div>
      <div class="carousel carousel-start space-x-4 w-96" style="width: 700px">
        <div class="carousel-item">
          <div class="bg-base-100 shadow-lg rounded p-3">
            <div class="group relative">
              ...
              >
                <button
                  @click="playAudio('china')"
                  class="hover:scale-110 opacity-0 transform translate-y-3 group-hover:translate-y-0 group-hover:opacity-100 transition"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="50"
            ...
            <div class="p-5">
              <h3 class="text-lg">Depan Lobby</h3>
              <p class="text-gray-400">J1</p>
            </div>
